...
export const tools: Omit<Feature, 'renderResult'>[] = [
  ...
  },
  {
    ...
    details: { steps: [], aiVsManual: [], synergy: [], faqs: [] },
    creationFields: [
        {id: 'projectId', name: 'Project', type: 'select', options: ['Emaar Beachfront', 'Damac Hills 2', 'Sobha Hartland', 'Add New Project...'], placeholder: 'Select a project', description: 'Choose a project to generate a plan for.' },
        {id: 'totalPrice', name: 'Total Property Price (AED)', type: 'number', placeholder: 'e.g., 2500000', description: 'The total value of the property.'},
        {id: 'planType', name: 'Plan Type', type: 'select', options: ['Standard', 'Post-Handover', 'Construction-Linked', 'Flexible (AI Suggestion)'], placeholder: 'Select a plan structure', description: 'Choose a common payment structure.'},
    ],
  },
  {
