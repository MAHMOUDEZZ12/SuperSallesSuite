...
const personas = [
  {
    name: 'For Investors',
    description: 'Analyze market trends, find off-market deals with high ROI potential, and leverage AI-powered price estimators to make data-driven decisions.',
  ...
  },
  {
    ...
    description: 'Automate marketing, generate high-quality leads, rebrand brochures instantly, and manage client relationships with an AI-powered CRM assistant.',
  ...
  {
    name: 'For Developers',
    description: 'Generate entire marketing campaigns, create stunning landing pages, and produce multi-language brochures for your projects in minutes, not weeks.',
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-20">
         <PageHeader 
            ...
            title="Ecosystem"
            description="WhatsMAP is a collaborative intelligence platform for the entire real estate universe. Discover how our tools empower every stakeholder."
        />
