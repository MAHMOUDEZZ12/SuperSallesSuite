...
function GenesisUI() {
    ...
    const handleSearch = (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        setHasSearched(true);
        // We push the query to the URL to make it bookmarkable and shareable
    ...
    // This effect ensures that if the page is loaded with a query param, the search runs automatically.
    useEffect(() => {
        if (initialQuery && !briefing && !isLoading) {
             const virtualEvent = { preventDefault: () => {} } as React.FormEvent;
             handleSearch(virtualEvent);
        }
    ...
    return (
        <div className="absolute inset-0 z-10 flex flex-col items-center text-white p-6">
                ...
                {!hasSearched && (
                    ...
                    >
                        <div className="flex justify-center items-center mb-4">
                           <Image src="https://firebasestorage.googleapis.com/v0/b/supersellerae-4rzzy.firebasestorage.app/o/white%20logo%20of%20whatsmapp.png?alt=media&token=5218d2c8-7f98-4665-90d9-79653d11ecc7" alt="WhatsMAP Logo" width={80} height={80} className="animate-spin-slow" />
                        </div>
            ...
            <AnimatePresence>
                {hasSearched && (
                    <motion.div 
                        className="w-full max-w-5xl mt-8 overflow-y-auto no-scrollbar"
